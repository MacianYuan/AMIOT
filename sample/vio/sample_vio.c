...
void SAMPLE_VIO_Usage(char *sPrgNm)
{
    ...
    printf("index:\n");
	printf("\t0:  VI 4chn, 720P input, HD VO \n");
	printf("\t1:  VI 4chn,CVBS PAL input, HD VO\n");
	printf("\t2:  VI 4chn ,1080p input, HD VO\n");
...
void SAMPLE_VIO_FB0_Enable(HI_VOID)
{
...
HI_S32 SAMPLE_VIO_4_1080P(HI_VOID)
{
    ...
    ******************************************/
    ...
    u32WndNum = 4;//8
    enVoMode = VO_MODE_4MUX;//VO_MODE_9MUX
	...
	//SAMPLE_VIO_FB0_Enable();//open fb0 for QT or other GUI
...
HI_S32 SAMPLE_VIO_NTSC(HI_VOID)
{
	SAMPLE_VI_MODE_E enViMode = SAMPLE_VI_MODE_16_D1;
	VIDEO_NORM_E enNorm = VIDEO_ENCODING_MODE_NTSC;
...
int main(int argc, char *argv[])
{
	...
	switch(*argv[1])
	{
		case '0':/* VI:4*720P;VPSS VO:HD0(HDMI|VGA)*/
			s32Ret = SAMPLE_VIO_4_720P();
			break;
		case '1':/* 4 CVBS PAL */
			s32Ret = SAMPLE_VIO_PAL();
			break;
		case '2':/* VI:4*1080P;VPSS VO:HD0(HDMI|VGA)*/
			s32Ret = SAMPLE_VIO_4_1080P();
			break;
		case '3':/* VI:16*720P;VPSS VO:HD0(HDMI|VGA); VPSS VO:SD0(CVBS)*/
			//s32Ret = SAMPLE_VIO_16_720P();
			break;
