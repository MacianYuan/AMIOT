 ...
 *******************************************************************************/
/* Atype is THD*/
int __recovery_Atype_logic1( int ch, int curvidmode, int vfmt, int acc_gain_status, int dc_val, int ac_min_val, int ac_max_val, int dc_value );
void __recovery_Atype_logic2( int ch, int curvidmode, int vfmt, int acc_gain_status, int dc_val, int ac_min_val, int ac_max_val, int dc_value );
void __recovery_Atype_logic3( int ch, int curvidmode, int vfmt, int acc_gain_status, int dc_val, int ac_min_val, int ac_max_val, int dc_value );

/* Btype is AHD, CVI */
void __recovery_Btype_logic1( int ch, int curvidmode, int vfmt, int acc_gain_status, int y_minus_slope, int y_plus_slope);
void __recovery_Btype_logic2( int ch, int curvidmode, int vfmt, int acc_gain_status, int y_minus_slope, int y_plus_slope);
void __recovery_Btype_logic3( int ch, int curvidmode, int vfmt, int acc_gain_status, int y_minus_slope, int y_plus_slope);
...
*	Argurments		: ch(channel information), curvidmode(Current Video mode)
*					  acc_gain_status(ACC gain status-Auto Color Gain), dc_val(DC value),
*					  ac_min_val(ACC Min value), ac_max_val(ACC max value),
*					  dc_value(DC value)
*	Return value	: void
*	Modify			:
*	warning			:
...
*	Argurments		: ch(channel information), curvidmode(Current Video mode)
*					  acc_gain_status(ACC gain status-Auto Color Gain),
*					  y_minus_slope(Y minus slope),  y_plus_slope(Y minus slope)
*	Return value	: void
*	Modify			:
*	warning			:
*******************************************************************************/
...
*******************************************************************************/
int __eq_recovery_Atype( int ch, int curvidmode, int vfmt, int acc_gain_status, int dc_val, int ac_min_val, int ac_max_val, int dc_value )
{
	int ret=0x7FF;
	/* recovery logic of EQ */
#if  defined (SUPPORT_RECOVERY_TYPE1_EQ)
	ret = __recovery_Atype_logic1( ch, curvidmode, vfmt, acc_gain_status, dc_val, ac_min_val, ac_max_val, dc_value);
#elif defined(SUPPORT_RECOVERY_TYPE2_EQ)
	__recovery_Atype_logic2( ch, curvidmode, vfmt, acc_gain_status, dc_val, ac_min_val, ac_max_val, dc_value);
#elif defined(SUPPORT_RECOVERY_TYPE3_EQ)
	__recovery_Atype_logic3( ch, curvidmode, vfmt, acc_gain_status, dc_val, ac_min_val, ac_max_val, dc_value);
#endif
	return ret;
}
...
*******************************************************************************/
void __eq_recovery_Btype( int ch, int curvidmode, int vfmt, int acc_gain_status, int y_minus_slope, int y_plus_slope )
{
	/* recovery logic of EQ */
#if  defined (SUPPORT_RECOVERY_TYPE1_EQ)
	__recovery_Btype_logic1( ch, curvidmode, vfmt, acc_gain_status, y_minus_slope, y_plus_slope);
#elif defined(SUPPORT_RECOVERY_TYPE2_EQ)
	__recovery_Btype_logic2( ch, curvidmode, vfmt, acc_gain_status, y_minus_slope, y_plus_slope);
#elif defined(SUPPORT_RECOVERY_TYPE3_EQ)
	__recovery_Btype_logic3( ch, curvidmode, vfmt, acc_gain_status, y_minus_slope, y_plus_slope);
#endif
}
/*******************************************************************************
*	End of file
